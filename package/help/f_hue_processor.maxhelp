        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "Hue-selective saturation, luminance, and hue shift",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 15.0, 150.0, 270.0, 150.0 ],
                    "saved_attribute_attributes": {
                        "textcolor": { "expression": "themecolor.live_control_fg" }
                    },
                    "text": "External Control Messages\n\nsat_amt [-1.0 -- 1.0]\nlum_shift [-1.0 -- 1.0]\nhue_shift [-180.0 -- 180.0]\nedge_falloff [0.0 -- 90.0]\nbypass [0 / 1]\n\nNote: hue_center / hue_lower / hue_upper\nare UI-only (rslider) -- not remotely addressable.",
                    "textjustification": 0
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 15.0, 348.0, 270.0, 180.0 ],
                    "text": "References\n\nHue selection via signed angular distance\nin normalized hue space [0,1].\nFlat-top band with smoothstep falloff edges.\n\nSaturation gate suppresses mask for near-neutral\npixels (S < 0.05--0.15) whose hue is undefined.\n\nHSV operations applied within band;\nreconstruction via branch-free HSV->RGB.\n\nOriginal derivation -- not from external source."
                }
            },
            {
                "box": {
