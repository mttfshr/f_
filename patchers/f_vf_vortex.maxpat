{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 40.0, 0.0, 81.0, 21.0 ],
                    "text": "vecfield",
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 10,
                    "outlettype": [ "", "", "", "", "", "", "", "", "", "" ],
                    "patching_rect": [ 200.0, 130.0, 483.0, 22.0 ],
                    "text": "route cx cy convergence curl falloff cx_amt cy_amt convergence_amt curl_amt"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 200.0, 380.0, 284.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 20.0, 20.0, 196.0, 160.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 0.0, 0.0, 196.0, 160.0 ],
                    "proportion": 0.5
                }
            },
            {
            ...
            },
            {
                "box": {
                    "activedialcolor": [ 0.8, 0.8, 0.8, 1.0 ],
                    "fontname": "Ableton Sans Light",
                    "hint": "Inward pull. 0=none, >0=sink, <0=source",
                    "id": "obj-26",
                    "maxclass": "live.dial",
                    "numinlets": 1,
                    "numoutlets": 2,
                    ...
                    "saved_attribute_attributes": {
                        ...
                        "valueof": {
                            ...
                            "parameter_initial_enable": 1,
                            "parameter_linknames": 1,
                            "parameter_longname": "convergence",
                            "parameter_mmax": 1.0,
                            "parameter_mmin": -1.0,
                            "parameter_modmode": 3,
                            "parameter_shortname": "convergence",
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 150.0, 230.0, 157.0, 22.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    "activedialcolor": [ 0.8, 0.8, 0.8, 1.0 ],
                    "fontname": "Ableton Sans Light",
                    "hint": "Rotation. 0=none, >0=CCW, <0=CW",
                    "id": "obj-29",
                    "maxclass": "live.dial",
                    "numinlets": 1,
                    "numoutlets": 2,
                    ...
                    "saved_attribute_attributes": {
                        ...
                        "valueof": {
                            ...
                            "parameter_initial_enable": 1,
                            "parameter_linknames": 1,
                            "parameter_longname": "curl",
                            "parameter_mmax": 1.0,
                            "parameter_mmin": -1.0,
                            "parameter_modmode": 3,
                            "parameter_shortname": "curl",
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 200.0, 260.0, 127.5, 22.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    "activedialcolor": [ 0.8, 0.8, 0.8, 1.0 ],
                    "fontname": "Ableton Sans Light",
                    "hint": "Exponential falloff rate. 0=uniform field",
                    "id": "obj-32",
                    "maxclass": "live.dial",
                    "numinlets": 1,
                    "numoutlets": 2,
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 250.0, 290.0, 129.0, 22.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 350.0, 350.0, 127.5, 22.0 ]
                }
            },
            {
                "box": {
                ...
                "box": {
                    ...
                    "saved_attribute_attributes": {
                        ...
                        "valueof": {
                            ...
                            "parameter_initial_enable": 1,
                            "parameter_linknames": 1,
                            "parameter_longname": "convergence_amt",
                            "parameter_mmax": 1.0,
                            "parameter_modmode": 3,
                            "parameter_shortname": "convergence_amt",
                            "parameter_type": 0,
                            "parameter_unitstyle": 1
                        }
                    },
                    ...
                    "valuepopup": 1,
                    "valuepopuplabel": 1,
                    "varname": "convergence_amt"
                }
            },
            {
                "box": {
                    "attr": "convergence_amt",
                    "id": "obj-42",
                    "maxclass": "attrui",
                    "numinlets": 1,
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 400.0, 380.0, 185.0, 22.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 450.0, 410.0, 136.0, 22.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 174.0, 5.0, 18.0, 12.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 174.0, 5.0, 18.0, 12.0 ],
                    "valuepopuplabel": 1,
                    "varname": "bypass"
                }
            },
        ...
        "parameters": {
            "obj-20": [ "cx", "cx", 0 ],
            "obj-23": [ "cy", "cy", 0 ],
            "obj-26": [ "convergence", "convergence", 0 ],
            "obj-29": [ "curl", "curl", 0 ],
            "obj-32": [ "falloff", "falloff", 0 ],
            "obj-35": [ "cx_amt", "cx_amt", 0 ],
            "obj-38": [ "cy_amt", "cy_amt", 0 ],
            "obj-41": [ "convergence_amt", "convergence_amt", 0 ],
            "obj-44": [ "curl_amt", "curl_amt", 0 ],
            "parameterbanks": {
                "0": {
                    "index": 0,
                    "name": "",
