...
| `f_vortex_multi` | Generator | Three-site additive vortex field — independent per-site position, convergence, curl; 4 global mod inlets (cx, cy, conv, curl); f_vecfield producer |
